...

            {
                users.map((user, index) =>  <tr key={user._id}> 
                 ...
                 { user.role === "admin" ? "Admin" :  <button onClick={() => handleMakeAdmin(user._id)} className="btn btn-ghost btn-lg
                     bg-orange-400 text-white text-2xl "><FaUsers></FaUsers></button>}
                    </td>
                    </td>
                    <td>
                    <button onClick={() => handleDeleted(user._id)} className="btn btn-ghost btn-lg
                     text-red-600"><FaTrashAlt></FaTrashAlt></button>
                    </td>
                </tr>
                )
            }
